...
const LoanFooter = () => {
  return (
    <div className="loan-footer text-start text-gray-500  border-t p-4">
      ...
      <p className="mb-4">
        By submitting your information, you understand and agree to our Privacy
        Policy and Terms of Use.
      </p>
      <p className="mb-4">
        Short-term Loan 14-day APR Range: 2731.07% – 514.29% APR varies per
      ...
      <p className="mb-4">
        Customer Notice: Short-term advances should be used for short-term
      ...
      <p>
        California residents: By using this site, you acknowledge disclosure of
        your rights under the California Consumer Privacy Protection Act of 2018
        as disclosed in our California Resident’s Privacy Policy Addendum.
        <span className="text-green-600">Lending Forte </span> , Inc. is
