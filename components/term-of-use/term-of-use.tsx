  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <main>
        ...
        <p className="font-semibold">Last updated: January 17th, 2024.</p>
        ...
        <section className="mt-8">
          <h2 className="text-lg font-semibold">2. Agreement</h2>
          <p>
            By accessing, browsing, or using the Websites, you acknowledge that
            you understand, accept, and agree (i) to be bound by this Agreement,
            as well as our Privacy Policy, which is incorporated into this
            Agreement by reference; (ii) to the fullest extent required by the
            law of any state, that you have been provided with, have received,
            and are agreeing to all disclosure and consent requirements; and
            (iii) that you are of legal age and not prohibited by law from
            accessing or using the goods and Services offered herein. Certain
            ...
            referenced that apply to that Service. If you do not agree to all
            these Terms, then you may not access this Website or use any of its
            Services.
          </p>
        </section>

        <section className="mt-8">
          <h2 className="text-lg font-semibold">3. Modification</h2>
          <p>
            We reserve the right, in our sole discretion, to change these Terms
            at any time by posting revised terms on this Website. The date on
            which these Terms have been last updated will be noted immediately
            above this page and the revised Terms will take effect seven (7)
            days after their publication on this Website. Therefore, you should
            visit this page periodically to review any changes. Your continued
        ...
        <section className="mt-8">
          ...
          <p>
            You understand and agree that by submitting your loan request, you
            are providing written instruction under the Fair Credit Reporting
            Act authorizing us and/or the lenders with whom your request is
            shared to obtain your consumer credit report, credit score, and/or
            other information from any consumer reporting agency in order to
            provide you with quotes and verify your identity. These lenders may
            obtain your credit report, credit score, and other information to
            make a final decision before extending a loan to you. Additionally,
            you understand and agree that providers may use third party services
            to obtain information relating to you and to verify any information
            that you provide including, without limitation your social security
            number, address, phone number, bank account information and
            employment history.
          </p>
        </section>
        <section className="mt-8">
          <h2 className="text-lg font-semibold">5. Eligibility.</h2>
          <p>
            The Services on offered on this Website are not available to persons
            under the age of 18 or to persons who are not legal residents of the
            United States. By using this Website, apply for or using any of its
        ...
        <section className="mt-8">
          <h2 className="text-lg font-semibold">
            6. Services Offered by this Website.
          </h2>
          <p>
            Online Marketplace for Lenders and Other Providers. This Website
            functions as an online marketplace for you to find third party
            lenders and other providers that may be of interest to you. By
            clicking “Submit” or any button indicating acceptance, you are
            certifying that all of the information you have provided is your
            loan request form is true, accurate, and complete. Lenders and
            non-lenders (hereafter “Network Partners”) that participate in our
            network may use specific criteria, or filters, to identity the
            ...
            will then be directed to that Network Partner’s website where they
            may present you an offer for a loan or other products that may be of
            interest to you. If no Network Partner accepts your loan request, we
            may present you with an offer to submit another loan request or an
            offer for a different product. We also may share your contact
            ...
            connect you to third party lenders and non-lenders in our network.
            Your information may be shared with non-lenders or other
            intermediary service providers, to help connect you with a lender.
            Providing your information on this Website does not guarantee that
            you will be approved for a loan. Not all lenders can provide loans
            in the amounts advertised on the Websites. The amount of time to
            transfer funds may vary between lenders and may also depend on your
            individual financial institution. Lenders that participate in the
            services provided by this website do not offer loans in every state.
            If you are from a state that the lenders do not service, you will
            not be connected to a lender. For details, questions, or concerns
            regarding your loan, please contact the lender directly. Advertiser
            Disclosure. This Website provides its services to you free of charge
            but may receive payment from lenders and non-lenders for referring a
            lead to them. Your use of this Website’s services constitutes your
            agreement with this compensation arrangement. This Website does not
            endorse or recommend the services or products of any particular
            Network Partner. You should rely on your own judgment in deciding
            which available loan product, terms, lender and/or Network Partner
        ...
        <section className="mt-8">
          <h2 className="text-lg font-semibold">
            {" "}
            7. Data Sharing with Lenders, Providers, Non-Lending Financial
            Institutions, and Third Parties.
          </h2>
          <p>
            When you voluntarily submit your loan request, you understand and
            agree that we will share the information provided in the loan
            request form with lenders, providers, non-lending financial
            institutions, and third parties (also referred to as “Network
            Partners”). Network Partners may keep the information provided in
            your loan request form, and other information provided to us or
            received by them in the processing of your loan request, or other
            products or services that may be of interest to you. Network
            Partners may retain this information, whether or not you qualify for
